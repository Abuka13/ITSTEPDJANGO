...
''')
def sqlite_count_likes_db():
    with sqlite3.connect('database/database1.db') as conn:
        cursor = conn.cursor()
        cursor.execute('''
...
def sqlite_count_dislikes_db():
    with sqlite3.connect('database/database12.db') as conn:
        cursor = conn.cursor()
        cursor.execute('''
